...
static void Xbox360ControllerCallback(void *target,IOReturn result,void *refCon,void *sender) {
    if(target!=NULL) [((__bridge Xbox360Controller*)target) eventQueueFired:sender withResult:result];
}
#endif
...
-(void)startDevice {
    ...
    // Set callback
    ret=(*hidQueue)->setEventCallout(hidQueue,Xbox360ControllerCallback,(__bridge void *)(self),NULL);
    if(ret!=kIOReturnSuccess) {
